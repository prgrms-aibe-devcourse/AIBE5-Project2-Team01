...
public class ProjectRepositoryTest {
    ...
    void findProjectsWithFilters_Keyword() {
        // given
        projectRepository.save(new Project("Spring Boot 스터디", "요약", "설명", "사이드", "온라인", "팀장", "역할", "아", "썸", 0, 5, LocalDate.now(), LocalDate.now(), "Java"));
    ...
    void findProjectsWithFilters_Type() {
        // given
        projectRepository.save(new Project("스터디", "요약", "설명", "STUDY", "온라인", "팀장", "역할", "아", "썸", 0, 5, LocalDate.now(), LocalDate.now(), "Java"));
